...
import 'package:trash_report/paginas/primary_button.dart';
import 'auth.dart';
  ...
  List<Widget> usernameAndPassword() {
    return [
      padded(
        ...
        autocorrect: false,
        validator: (val) =>
            val.isEmpty ? 'El correo no puede estar vacío.' : null,
      ...
      case FormType.login:
        return [
          ...
          new FlatButton(
              ...
              child: new Text("Necesitas una cuenta? Regístrate."),
      ...
      case FormType.register:
        return [
          ...
          new FlatButton(
              ...
              child: new Text("Tienes cuenta? Ingresa"),
